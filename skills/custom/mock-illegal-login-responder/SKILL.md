...
- Run the script with `python /mnt/skills/custom/mock-illegal-login-responder/scripts/mock_auth.py ...` when using the DeerFlow skills mount.
...
4. Run `python /mnt/skills/custom/mock-illegal-login-responder/scripts/mock_auth.py context --username test`.
...
11. Run `python /mnt/skills/custom/mock-illegal-login-responder/scripts/mock_auth.py kick --username test`.
12. Run `python /mnt/skills/custom/mock-illegal-login-responder/scripts/mock_auth.py disable --username test`.
